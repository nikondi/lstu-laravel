...
@section('content')
                ...
                <li>
                    <button type="button">
                        ...
                        <svg width="12" height="12">
                            <use xlink:href="/assets/img/arrows.svg#bottom"/>
                        </svg>
                    </button>
    ...
    <section class="fak-info container">
        ...
        <div class="fak-info__text">
            ...
            <p>В состав института&nbsp;входят кафедры <a href="[[~19]]">автоматизированных систем управления</a>, <a
                    href="[[~20]]">информатики</a>, <a href="[[~21]]">прикладной математики</a>, <a href="[[~3585]]">автоматизированного
                    электропривода и робототехники</a>. В рамках кафедр института&nbsp;сформированы и интенсивно
                развиваются научные школы.</p>
            <ul>
        ...
        <div class="directions-list">
                ...
                <div class="direction__content first" style="">
                    ...
                    <ul>
                        <li>09.03.01 "Информатика и вычислительная техника",<br>
                            профиль <a
                                href="http://legacy.stu.lipetsk.ru/education/chair/kaf-asu/education/bachelor/as/">"Автоматизированные
                                системы обработки информации и управления"</a>;&nbsp;
                        </li>
                        <li>02.03.03 "Математическое обеспечение и администрирование информационных систем",<br>
                            профиль <a
                                href="http://legacy.stu.lipetsk.ru/education/chair/kaf-asu/education/bachelor/ai/">"Администрирование
                                информационных систем"</a>;
                        </li>
                        <li>09.03.04 "Программная инженерия",<br>
                            профиль <a
                                href="http://legacy.stu.lipetsk.ru/education/chair/kaf-asu/education/bachelor/pi/">"Разработка
                                программно-информационных систем"</a>.
                        </li>
                    </ul>
            ...
            <div class="direction">
                ...
                <div class="direction__content second">
                    <ul>
                        <li><a href="#">08.03.01 Строительство (Промышленное и гражданское строительство;
                                Теплогазоснабжение, вентиляция, водоснабжение и водоотведение, Урбанистика и
                                строительство)</a></li>
                        <li><a href="#">08.03.01 Строительство (Промышленное и гражданское строительство;
                                Теплогазоснабжение, вентиляция, водоснабжение и водоотведение, Урбанистика и
                                строительство)</a></li>
                ...
                <div class="swiper-wrapper">
                    @foreach(\Illuminate\Support\Facades\Storage::disk('public')->files('fak/IKN/partners') as $file)
                        <div class="swiper-slide fak-partner">
                            <a href="#">
                                <img src="{{ \Illuminate\Support\Facades\Storage::disk('public')->url($file) }}"
                                     title="{{ $file }}" alt="">
                            </a>
                        </div>
                    @endforeach
                ...
                <div class="swiper-wrapper">
                    <div class="fak-graduate swiper-slide">
                        <div class="fak-graduate__image">
                            <img
                                src="{{ \Illuminate\Support\Facades\Storage::disk('public')->url('/fak/IKN/graduates/trubnikov.png') }}"
                                alt="">
                        </div>
                        <div class="fak-graduate__position">академик РАН, директор Объединённого института ядерных
                            исследований
                        </div>
                    ...
                    <div class="fak-graduate swiper-slide">
                        <div class="fak-graduate__image">
                            <img
                                src="{{ \Illuminate\Support\Facades\Storage::disk('public')->url('/fak/IKN/graduates/chebotarev.png') }}"
                                alt="">
                        </div>
                        <div class="fak-graduate__position">академик РАН, директор Объединённого института ядерных
                            исследований
            ...
            <div class="swiper news-slider">
                <div class="slider-heading">
                    ...
                    <div class="slider-heading__buttons">
                        ...
                        <button class="slider-heading__button slider-heading__button--dark">
                            Все новости
                            <svg width="1em" height="1em">
                                <use xlink:href="http://localhost/assets/img/arrows.svg#right"></use>
                            </svg>
